...
export function usePasswordStrength(
  ...
  useEffect(() => {
    // Always schedule (async setState is fine): non-empty announcements are
    // announced after announceDelay, and clearing the input resets settled
    // back to "" after the same delay.
